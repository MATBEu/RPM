...
bulba::bulba(std::string name) : pokemon(name)
{
	this->specialAttack = -1;
	this->specialDefense = -1;
}

void bulba::setSpecialAttack(int specialAttack)
{
	this->specialAttack = specialAttack;
}

void bulba::setSpecialDefense(int specialDefense)
{
	this->specialDefense = specialDefense;
}

std::string bulba::initJson()
{
	pokemon::initJson();	
